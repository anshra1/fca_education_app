...
class NotificationCubit extends Cubit<NotificationState> {
  ...
  Future<void> clear(String notificationId) async {
    ...
    final result = await _clear(params: notificationId);
    result.fold(
  ...
  Future<void> markAsRead(String notificationId) async {
    final result = await _markAsRead(params: notificationId);
    result.fold(
      (failure) => emit(NotificationError(failure.errorMessage)),
  ...
  Future<void> sendNotification(Notification notification) async {
    ...
    final result = await _sendNotification(params: notification);
    result.fold(
      (failure) => emit(NotificationError(failure.errorMessage)),
