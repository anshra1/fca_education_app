...
import 'package:fca_education_app/src/course/features/materials/presentation/widgets/edit_resource_dialog.dart';
import 'package:fca_education_app/src/course/features/materials/presentation/widgets/picked_resource_tile.dart';
...
class _AddMaterialsViewState extends State<AddMaterialsView> {
  ...
  Future<void> editResource(int resourceIndex) async {
    //   final resourcesd = resources.elementAt(resourceIndex);
  ...
  Widget build(BuildContext context) {
    return NotificationWrapper(
      ...
      child: BlocListener<MaterialCubit, MaterialStates>(
        listener: (context, state) {
          ...
          if (state is MaterialError) {
            ...
            CoreUtils.sendNotification(
              ...
              category: NotificationCatgory.MATERIAL,
            );
